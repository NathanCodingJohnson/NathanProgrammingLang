...
class RTEError(Error):
    ...
    def generate_traceback(self):
        ...
        return 'Nathaniel Traceback (most recent = last): \n' + result
...
class Lexer:
    ...
    def advance(self):
        ...
        self.current_char = self.text[self.pos.idx] if self.pos.idx < len(self.text) else None #### maybe error?
...
#
    ...
    def atom(self):
        ...
        # parenth handling
            ...
            # look for right parenth or error
    ...
    def expr(self):
        ...
        if self.current_tok.matches(TT_KEYWORD, 'VAR'):
            ...
            res.register(self.advance())
            expr = res.register(self.expr())
            if res.error: return res.success(VarAssignNode(var_name, expr))
...
# storing values of numbers to preform operations
class Number:
    ...
    def dived_by(self, other):
        if isinstance(other, Number):
            # check and throw error for div by 0
            if other.value == 0:
                return None, RTEError(other.pos_start, other.pos_end, 'Division by zero', self.context)
            return Number(self.value / other.value).set_context(self.context), None
...
class Interpreter:
    ...
    def no_visit_method(sef, node, context):
    ...
    def visit_NumberNode(self, node, context):
        #print("Found number node")
            # runtime will alway succeed because no operations
    ...
    def visit_VarAccessNode(self, node, context):
        ...
        if not value:
            return res.failure(RTEError(node.pos_start, node.pos_end, f"'{var_name}' is not defined", context))
    ...
    def visit_UnaryOpNode(self, node, context):
        ...
        # if negative, multiply number by -1
